/* eslint-disable */
// Generated by Wrangler by running `wrangler types --strict-vars=false` (hash: 27f896c6671318af982aa093ebbcc6fe)
// Runtime types generated with workerd@1.20260918.1 2026-09-01 nodejs_compat
interface __BaseEnv_Env {
	RUNS_DB: D1Database;
	PEOPLE_INDEX: VectorizeIndex;
	BROWSER: BrowserRun;
	AI: Ai;
	LLM_PROFILE: string;
	OPENAI_MODEL: string;
	...
	RunHub: DurableObjectNamespace<import("./src/server/index").RunHub>;
	People: DurableObjectNamespace<import("./src/server/index").People>;
	BOOKING_WORKFLOW: Workflow<Parameters<import("./src/server/index").BookingWorkflow['run']>[0]['payload']>;
	RESEARCH_WORKFLOW: Workflow<Parameters<import("./src/server/index").ResearchWorkflow['run']>[0]['payload']>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/server/index");
		durableNamespaces: "PlanAgent" | "RunHub" | "People";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "LLM_PROFILE" | "OPENAI_MODEL" | "BOOKING_DRY_RUN" | "IMESSAGE_APP_NAME" | "LOG_BODIES" | "BROWSERBASE_API_KEY" | "LINQ_API_KEY" | "PUBLIC_BASE_URL" | "LINQ_WEBHOOK_SECRET" | "DEV_LLM_BASE_URL" | "DEV_LLM_API_KEY" | "DEV_LLM_MODEL" | "RUNS_TOKEN" | "BROWSERBASE_CONTEXT_ID">> {}
}
