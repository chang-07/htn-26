...
export function WidgetFlipCard({ widget, onEdit }: { widget: SavedWidget; onEdit: () => void }) {
  ...
  return <EventFlipCard title={widget.title} subtitle={widget.sample ? "Example widget" : "Your widget"} label={widget.kind} accent={isGame ? ACCENT_PALETTE.pinkSoft : ACCENT_PALETTE.tealSoft} actionLabel={isGame ? "Play" : "Open poll"}
