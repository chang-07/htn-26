...
void main() {
  ...
  float focus = mix(clamp(uIdleReveal, 0.0, 1.0), 1.0, clamp(loupe * act, 0.0, 1.0));
  ...
  // Reveal the original artwork without refracting faces around the cursor.
  vec3 sharp = gradeRGB(texture(tMap, coverUv(vUv)).rgb);
...
const HalftoneReveal = ({
  ...
  if (unavailable) return <img src={src} alt="" style={{ width: "100%", height: "100%", objectFit: "cover", borderRadius }} />;
