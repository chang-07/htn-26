    ...
    <section aria-label="Run performance and errors" style={{ margin: "10px 0 14px 4px", background: "var(--paper2)" }}>
      ...
      {open && (
        <div style={{ padding: "4px 14px 14px", display: "flex", flexDirection: "column", gap: 14 }}>
          ...
          {d.ranked.length > 0 && (
            <div>
              <p className="rv-meta" style={{ margin: "0 0 6px" }}>Slowest operations · cumulative</p>
              ...
              <p style={{ margin: "6px 0 0", fontSize: 11.5, color: "var(--soft)" }}>
                Durations can overlap or nest, so they do not add up to wall time. Leaf operations occupy {dur(d.occupiedMs)}.
              </p>
            </div>
          )}
          {d.errors.length > 0 && (
