...
export function EventFlipCard({ title, subtitle, label, image, accent = "#c7baff", preview, actionLabel = "View details", children }: Props) {
  ...
  return <FlipCard className="event-flip" width={440} height={480} radius={18} background="#fff" color="#282827" flipped={flipped} onFlipChange={setFlipped} interactiveContent flipOnClick={false} draggable={false} tilt={false} glare={false} hoverScale={1} shadow={false} ariaLabel={title}
